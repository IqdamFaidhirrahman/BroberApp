    ...
    private void checkIfProfileExists() {
        databaseReference.limitToFirst(1).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && profileId == null) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        Intent intent = new Intent(ProfilActivity.this, ProfilDetail.class);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(ProfilActivity.this, "Failed to check profile: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
