...
public class ProfilDetail extends AppCompatActivity {
    ...
    private Button deleteButton, editButton, historyButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyButton = findViewById(R.id.booking_button);
    ...
    private void deleteProfile() {
        ...
        databaseReference.removeValue().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Intent intent = new Intent(ProfilDetail.this, ProfilActivity.class);
    ...
    private void showHistory() {
        Intent intent = new Intent(ProfilDetail.this, HistoryActivity.class);
        startActivity(intent);
    }
